...
thermal drift of the machine; the drift moves absolute times by tens of
percent between sessions, so the per-step entries of this chapter are not
comparable with Table~\ref{tab:seqbaseline}, whose entries are wall times
of whole runs from another session.
