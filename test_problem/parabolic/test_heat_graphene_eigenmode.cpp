...
int main(int argc, char *argv[]) {
	try {
		...
		problem.set_output_directory("output/visualization/graphene_eigenmode");
		...
		std::ofstream decay_out(
			"output/convergence/graphene_eigenmode_decay.csv");
