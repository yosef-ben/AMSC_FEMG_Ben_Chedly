...
| `27/amyloid_phase_crossings` (report: the amyloid stations region by region, the figure behind the quoted group means) | `plot-amyloid-phase-crossings.py` | `amyloid_profiles.csv`, `21/results/reaction_coefficients.csv` | `test_fisher_kolmogorov_fornari83`, `be_lumped`, `neocortex` seeding |
